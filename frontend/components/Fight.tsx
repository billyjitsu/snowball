...
const Fight = () => {
  ...
  return (
    <div className="bg-black h-screen w-full ">
      <>
        {!loading && (
          <div className="flex flex-col md:flex-row justify-center h-screen w-full">
            <div className="relative flex w-full h-screen content-center items-center justify-center z-10 bg-gradient-to-b from-black to-slate-300">
